...
| **Arquitectura modular / fronteras (ADR-038)** | [`docs/ADR-038-EN1-MODULAR-DOMAIN-ARCHITECTURE.md`](docs/ADR-038-EN1-MODULAR-DOMAIN-ARCHITECTURE.md) (**Propuesto**; F0 DONE) · inventario: [`docs/EN1_ADR038_F0_MODULE_DOMAIN_INVENTORY.md`](docs/EN1_ADR038_F0_MODULE_DOMAIN_INVENTORY.md) · **F1–F8 OFF** hasta GO · Planilla = EXTERNAL (no ops en EN1) |
| **Integraciones M2M (ADR-037)** | [`docs/ADR-037-INTEGRATIONS-M2M-CREDENTIALS-OPERATIONS.md`](docs/ADR-037-INTEGRATIONS-M2M-CREDENTIALS-OPERATIONS.md) (**ACCEPTED CODITO**; SPAGHETTI pendiente) · impl OFF hasta GO |
