...
| **Release Management (DEV→STG→PROD)** | [`docs/ADR-018-RELEASE-MANAGEMENT.md`](docs/ADR-018-RELEASE-MANAGEMENT.md) · paquete: [`docs/releases/EN1_RELEASE_v1.0.0.md`](docs/releases/EN1_RELEASE_v1.0.0.md) |
...
| **Jerarquía admin (SA / Tenant / Producto)** | [`docs/ADR-019-ADMINISTRATIVE-HIERARCHY.md`](docs/ADR-019-ADMINISTRATIVE-HIERARCHY.md) |
| **Order Events ownership (EPosOne ↔ EN1)** | [`docs/ADR-020-ORDER-EVENT-OWNERSHIP.md`](docs/ADR-020-ORDER-EVENT-OWNERSHIP.md) |
| **Installation Lifecycle (integrado)** | [`docs/ADR-021-EPOSONE-INSTALLATION-LIFECYCLE.md`](docs/ADR-021-EPOSONE-INSTALLATION-LIFECYCLE.md) · contrato: [`docs/EN1_EPOSONE_INSTALLATION_LIFECYCLE_CONTRACT_V1.md`](docs/EN1_EPOSONE_INSTALLATION_LIFECYCLE_CONTRACT_V1.md) |
| **Modelo comercial multiproducto** | [`docs/ADR-022-EN1-MULTIPRODUCT-COMMERCIAL-MODEL.md`](docs/ADR-022-EN1-MULTIPRODUCT-COMMERCIAL-MODEL.md) (**propuesto** — org = activo raíz; productos aditivos) |
| **Dominio Comercial EN1 (ETS)** | [`docs/ADR-031-EN1-COMMERCIAL-DOMAIN-ARCHITECTURE.md`](docs/ADR-031-EN1-COMMERCIAL-DOMAIN-ARCHITECTURE.md) (**ACCEPTED**; Fase 1: `/start` sin árbol ops) · [`docs/EN1_MODELO_COMERCIAL_V1.md`](docs/EN1_MODELO_COMERCIAL_V1.md) |
| **Arquitectura modular / fronteras (ADR-038)** | [`docs/ADR-038-EN1-MODULAR-DOMAIN-ARCHITECTURE.md`](docs/ADR-038-EN1-MODULAR-DOMAIN-ARCHITECTURE.md) (**Propuesto**; F0+F1 DONE Dev) · inventario: [`docs/EN1_ADR038_F0_MODULE_DOMAIN_INVENTORY.md`](docs/EN1_ADR038_F0_MODULE_DOMAIN_INVENTORY.md) · **F2–F8 OFF** · Products/Inventory slice → **ADR-039** |
| **Products & Inventory nativo (ADR-039)** | [`docs/ADR-039-EN1-PRODUCTS-INVENTORY-CONNECTED.md`](docs/ADR-039-EN1-PRODUCTS-INVENTORY-CONNECTED.md) (**ACCEPTED**; F0–F6 DONE Dev) · F5: [`docs/EN1_ADR039_F5_CONNECTED_CATALOG_DISCOVERY.md`](docs/EN1_ADR039_F5_CONNECTED_CATALOG_DISCOVERY.md) · F6: [`docs/EN1_ADR039_F6_CONNECTED_INVENTORY_BRIDGE.md`](docs/EN1_ADR039_F6_CONNECTED_INVENTORY_BRIDGE.md) · canónico `core_product` + `core_stock_*` · **EP1 client OFF** · STG/PRD NO TOCAR sin GO |
| **Integraciones M2M (ADR-037)** | [`docs/ADR-037-INTEGRATIONS-M2M-CREDENTIALS-OPERATIONS.md`](docs/ADR-037-INTEGRATIONS-M2M-CREDENTIALS-OPERATIONS.md) (**ACCEPTED CODITO**; SPAGHETTI pendiente) · inventario: [`docs/EN1_ADR037_M2M_INVENTORY.md`](docs/EN1_ADR037_M2M_INVENTORY.md) · **F1–F3 OFF** hasta GO · PROD M2M bloqueado |
| **Implementación de productos** | [`docs/ADR-032-PRODUCT-IMPLEMENTATION-MODEL.md`](docs/ADR-032-PRODUCT-IMPLEMENTATION-MODEL.md) (**ACCEPTED** v1.1) |
| **Asistente Standalone (APK)** | [`docs/ADR-033-STANDALONE-ONBOARDING-ASSISTANT.md`](docs/ADR-033-STANDALONE-ONBOARDING-ASSISTANT.md) (**ACCEPTED** v1.2) — LOCAL · GO implementación pendiente |
| **Provisioning Connected** | [`docs/ADR-034-CONNECTED-PROVISIONING-FLOW.md`](docs/ADR-034-CONNECTED-PROVISIONING-FLOW.md) (**ACCEPTED** v1.2) — CODITO · GO implementación pendiente |
| **Activación Licencia/Token/QR** | [`docs/ADR-035-ACTIVATION-LICENSE-TOKEN-QR.md`](docs/ADR-035-ACTIVATION-LICENSE-TOKEN-QR.md) (**ACCEPTED** v1.2) |
| **Gate implementación** | [`docs/EN1_COMMERCIAL_IMPLEMENTATION_GATE.md`](docs/EN1_COMMERCIAL_IMPLEMENTATION_GATE.md) — **LIBERADO** (033+034+035 ACCEPTED); orden recomendado 033→035→034 |
| Eventos EN1 (módulo) | [`.cursor/rules/easynodeone-events-en1-plan.mdc`](.cursor/rules/easynodeone-events-en1-plan.mdc) |
| **Plataforma EN1 (Master Plan)** | [**Constitución plataforma V1**](docs/EN1_PLATFORM_CONSTITUTION_V1.md) · [`docs/EN1_PLATFORM_MASTER_PLAN.md`](docs/EN1_PLATFORM_MASTER_PLAN.md) · carriles: [`docs/EN1_PLATFORM_CARRILES_Y_SOPORTE.md`](docs/EN1_PLATFORM_CARRILES_Y_SOPORTE.md) · Etapa 1: [`docs/EN1_PLATFORM_ETAPA1_CORE_APPS.md`](docs/EN1_PLATFORM_ETAPA1_CORE_APPS.md) · Sprint UX transición apps: [`docs/EN1_PLATFORM_SPRINT_UX_TRANSICION_APPS.md`](docs/EN1_PLATFORM_SPRINT_UX_TRANSICION_APPS.md) · **EPosOne V4:** [`docs/EN1_PLATFORM_EPOSONE_V4_ROADMAP.md`](docs/EN1_PLATFORM_EPOSONE_V4_ROADMAP.md) · [POS + licenciamiento](docs/EN1_PLATFORM_EPOSONE_V4_POS_LICENSING_ROADMAP.md) · [**Etapa 2 Android**](docs/EN1_PLATFORM_EPOSONE_V4_ANDROID_ETAPA2.md) · [**ADR-027 Onboarding unificado**](docs/ADR-027-EPOSONE-ONBOARDING-UNIFICADO-V1.md) · [**ADR-028 Plan/overrides**](docs/ADR-028-EPOSONE-PLAN-DEFAULTS-COMMERCIAL-OVERRIDES.md) · [`eposone-onboarding/`](docs/eposone-onboarding/README.md) · [**Hito EN1-01**](docs/EPOSONE_EN1_HITO1_PROVISIONING_CONTRACT.md) · [**Hito 2.5 Cajero**](docs/EPOSONE_EN1_HITO2_5_CASHIER_CONTRACT.md) · [**Handoff / dónde quedamos**](docs/EN1_EPOSONE_HANDOFF_STATUS.md) · [**Post-demo Mexican Food / P0 jueves**](docs/EN1_EPOSONE_POST_DEMO_MEXICAN_FOOD_PRIORITIES.md) · [**ADR-006 Op/Admin**](docs/ADR-006-EPOSONE-OPERATION-VS-ADMIN.md) · [**Hito 3 Pedido**](docs/EN1_EPOSONE_HITO3_ORDER_LIFECYCLE.md) · [**Hito 3 Spec V1**](docs/EN1_EPOSONE_HITO3_SPEC_FUNCIONAL_V1.md) · [**V5 Roadmap**](docs/EN1_PLATFORM_EPOSONE_V5_ROADMAP.md) · [**EN1-POS V7 (producto)**](docs/EN1_POS_V7_ROADMAP.md) · [**E2E Checklist**](docs/EN1_EPOSONE_E2E_CHECKLIST_V1.md) · [**Hito 2.6 Observabilidad**](docs/EN1_EPOSONE_HITO2_6_OBSERVABILITY.md) · [**Constitución**](docs/EN1_POS_CONSTITUCION_V1.md) · [**Domain Model**](docs/EN1_POS_DOMAIN_MODEL_V1.md) · [**DoD**](docs/EN1_POS_DEFINITION_OF_DONE_V1.md) · [**Gap capacidades**](docs/EN1_POS_CAPABILITY_GAP_V7.md) · [**Backlog V7**](docs/EN1_POS_BACKLOG_V7.md) · [**V6 contratos comerciales**](docs/EN1_PLATFORM_EPOSONE_V6_ROADMAP.md) · [**Modelo Comercial V1**](docs/EN1_EPOSONE_MODELO_COMERCIAL_V1.md) · [**Contrato Fiscal V1**](docs/EN1_EPOSONE_CONTRATO_FISCAL_V1.md) · [**Contrato Propinas V1**](docs/EN1_EPOSONE_CONTRATO_PROPINAS_V1.md) · [**Contrato Pagos V1**](docs/EN1_EPOSONE_CONTRATO_PAGOS_V1.md) · [**Contrato Recibo V1**](docs/EN1_EPOSONE_CONTRATO_RECIBO_V1.md) · [**Motor Comercial V1**](docs/EN1_EPOSONE_MOTOR_COMERCIAL_V1.md) · [**Motor Totales V1**](docs/EN1_EPOSONE_MOTOR_TOTALES_V1.md) · [**Infra Policy Engine**](docs/EN1_EPOSONE_COMMERCIAL_POLICY_ENGINE_INFRA_V1.md) · [**ADR-008**](docs/ADR-008-EPOSONE-COMMERCIAL-ENGINE.md) (Fase 5) · [**ADR-009 Caja EN1**](docs/ADR-009-EN1-CAJA-CENTRO-COBRO.md) · [**Order Domain Spec**](docs/EN1_EPOSONE_ORDER_DOMAIN_SPEC_V1.md) · [**Hito 3 HTTP Contract**](docs/EN1_EPOSONE_HITO3_ORDER_HTTP_CONTRACT.md) · ADR-001…005 ([licenciamiento POS](docs/ADR-005-EPOSONE-LICENSING-POS.md)) · [**ADR-011 Brand/ProductContext**](docs/ADR-011-PORTAL-ETS-PUNTO-ENTRADA.md) · [**ADR-012 Arquitectura ETS**](docs/ADR-012-ETS-ECOSYSTEM-ARCHITECTURE.md) · [**ADR-013 Portal ETS**](docs/ADR-013-PORTAL-ETS-PUNTO-ENTRADA.md) · [**ADR-014 Subscription Registry**](docs/ADR-014-SUBSCRIPTION-REGISTRY.md) · [**ADR-016 Licensing V2 Entitlement**](docs/ADR-016-COMMERCIAL-LICENSING-V2-ENTITLEMENT.md) · [**ADR-017 Customer Entry & Product Portal**](docs/ADR-017-CUSTOMER-ENTRY-POINT-PRODUCT-PORTAL.md) · [**ADR-018 Release Management**](docs/ADR-018-RELEASE-MANAGEMENT.md) · sync: [`docs/EN1_PLATFORM_EPOSONE_V4_SYNC.md`](docs/EN1_PLATFORM_EPOSONE_V4_SYNC.md) · código: `backend/nodeone/core/eposone_domain/` · license: `backend/nodeone/core/license/` · Core Etapa 2: `backend/nodeone/core/platform/` · [**EIS v1.0 Frozen**](docs/easyai/eis/README.md) · [ADR-026](docs/ADR-026-EASY-INTEGRATION-SPECIFICATION-V1.md) · [pack índice](docs/easyai/README.md) |
