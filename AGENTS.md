...
| **Dominio Comercial EN1 (ETS)** | [`docs/ADR-031-EN1-COMMERCIAL-DOMAIN-ARCHITECTURE.md`](docs/ADR-031-EN1-COMMERCIAL-DOMAIN-ARCHITECTURE.md) (**Aprobado arquitectura**; código pendiente GO) · resumen: [`docs/EN1_MODELO_COMERCIAL_V1.md`](docs/EN1_MODELO_COMERCIAL_V1.md) · proveedor prod = org **#1 Easy NodeOne Producción** |
| **Implementación de productos** | [`docs/ADR-032-PRODUCT-IMPLEMENTATION-MODEL.md`](docs/ADR-032-PRODUCT-IMPLEMENTATION-MODEL.md) (**Aprobado** v1.1) — ¿quién implementa? Autogestionada / Asistida |
| **Asistente Standalone (APK)** | [`docs/ADR-033-STANDALONE-ONBOARDING-ASSISTANT.md`](docs/ADR-033-STANDALONE-ONBOARDING-ASSISTANT.md) (**PROPOSED**) — onboarding local; handoff LOCAL; **sin** GO de código |
| **Provisioning Connected** | [`docs/ADR-034-CONNECTED-PROVISIONING-FLOW.md`](docs/ADR-034-CONNECTED-PROVISIONING-FLOW.md) (**PROPOSED**) — implementación asistida; handoff CODITO |
| **Activación Licencia/Token/QR** | [`docs/ADR-035-ACTIVATION-LICENSE-TOKEN-QR.md`](docs/ADR-035-ACTIVATION-LICENSE-TOKEN-QR.md) (**PROPOSED**) — orden=Licencia; QR=transporte |
