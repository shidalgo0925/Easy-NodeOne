...
| **Implementación de productos** | [`docs/ADR-032-PRODUCT-IMPLEMENTATION-MODEL.md`](docs/ADR-032-PRODUCT-IMPLEMENTATION-MODEL.md) (**PROPOSED** v1.1) — ¿quién implementa? Autogestionada / Asistida · Licencia→Token→QR |
| **Asistente Standalone (APK)** | [`docs/ADR-033-STANDALONE-ONBOARDING-ASSISTANT.md`](docs/ADR-033-STANDALONE-ONBOARDING-ASSISTANT.md) (**PROPOSED**) — onboarding local post-activación; handoff LOCAL; **sin** GO de código |
