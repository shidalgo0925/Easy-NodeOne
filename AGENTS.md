...
| **Products & Inventory nativo (ADR-039)** | [`docs/ADR-039-EN1-PRODUCTS-INVENTORY-CONNECTED.md`](docs/ADR-039-EN1-PRODUCTS-INVENTORY-CONNECTED.md) (**ACCEPTED**; F0–F4 DONE Dev) · F0: [`docs/EN1_ADR039_F0_PRODUCTS_INVENTORY_DISCOVERY.md`](docs/EN1_ADR039_F0_PRODUCTS_INVENTORY_DISCOVERY.md) · canónico `core_product` + `core_stock_*` · UI `/admin/inventory` · **F5+ OFF** · EP1/STG/PRD NO TOCAR |
