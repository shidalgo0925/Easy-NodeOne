...
| **Implementación de productos** | [`docs/ADR-032-PRODUCT-IMPLEMENTATION-MODEL.md`](docs/ADR-032-PRODUCT-IMPLEMENTATION-MODEL.md) (**PROPOSED**) — Autogestionada (Standalone) / Asistida (Connected); **sin** GO de código |
