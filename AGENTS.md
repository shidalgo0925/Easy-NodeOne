...
| **Products & Inventory nativo (ADR-039)** | [`docs/ADR-039-EN1-PRODUCTS-INVENTORY-CONNECTED.md`](docs/ADR-039-EN1-PRODUCTS-INVENTORY-CONNECTED.md) (**ACCEPTED**; F0–F7 DONE Dev) · F5–F7: discovery + bridge + bootstrap Δ · **Flutter consumer OFF** · STG/PRD NO TOCAR sin GO |
