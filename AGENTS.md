...
| **Dominio Comercial EN1 (ETS)** | [`docs/ADR-031-EN1-COMMERCIAL-DOMAIN-ARCHITECTURE.md`](docs/ADR-031-EN1-COMMERCIAL-DOMAIN-ARCHITECTURE.md) (**Aprobado**; Fase 1 código: `/start` sin árbol ops) · [`docs/EN1_MODELO_COMERCIAL_V1.md`](docs/EN1_MODELO_COMERCIAL_V1.md) · proveedor prod = org **#1** |
| **Implementación de productos** | [`docs/ADR-032-PRODUCT-IMPLEMENTATION-MODEL.md`](docs/ADR-032-PRODUCT-IMPLEMENTATION-MODEL.md) (**Aprobado** v1.1) |
| **Asistente Standalone (APK)** | [`docs/ADR-033-STANDALONE-ONBOARDING-ASSISTANT.md`](docs/ADR-033-STANDALONE-ONBOARDING-ASSISTANT.md) (**PROPOSED** v1.1 completo revisión) — LOCAL; **sin** código |
| **Provisioning Connected** | [`docs/ADR-034-CONNECTED-PROVISIONING-FLOW.md`](docs/ADR-034-CONNECTED-PROVISIONING-FLOW.md) (**PROPOSED** v1.1 completo revisión) — CODITO; **sin** código |
| **Activación Licencia/Token/QR** | [`docs/ADR-035-ACTIVATION-LICENSE-TOKEN-QR.md`](docs/ADR-035-ACTIVATION-LICENSE-TOKEN-QR.md) (**PROPOSED** v1.1 completo revisión) — **sin** código |
| **Gate post Fase 1** | [`docs/EN1_COMMERCIAL_IMPLEMENTATION_GATE.md`](docs/EN1_COMMERCIAL_IMPLEMENTATION_GATE.md) — congelar comercial; no implementar Standalone/Connected hasta aprobar 033+034+035 |
