...
class ElectronicInvoiceDocument(db.Model):
    ...
    consultation_url = db.Column(db.String(500), nullable=True)
    qr_source = db.Column(db.String(40), nullable=True)
    pac_document_id = db.Column(db.String(80), nullable=True)
