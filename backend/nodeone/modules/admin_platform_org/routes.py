...
def register_admin_platform_org_routes(app):
    ...
    def _product_guide_product_lines():
        return [
            ...
            {'id': 'line-epayroll', 'expanded': True, 'image': 'product-epayroll.png', 'name': 'EPayRoll', 'title_question': 'Que cubre?', 'intro': 'Gestion de planilla y nomina: calculo de salarios, deducciones y reportes legales.', 'bullets': [], 'footer_title': 'Logo', 'footer': 'static/images/logo-epayroll.png', 'rich': False},
