            ...
            for recipient in recipients:
                ...
                try:
                    ...
                    M.email_service.send_email(
                        subject=f'[Easy Thesis] Nuevo registro: {event.title}',
        ...
        try:
            ...
            for recipient in recipients:
                ...
                try:
                    ...
                    M.email_service.send_email(
                        subject=f'[Easy Thesis] Cancelación de registro: {event.title}',
                        recipients=[recipient.email],
                        html_content=html_content,
                ...
                if user:
                    ...
                    try:
                        ...
                        if not NotificationEngine._smtp_ready(oid, last_smtp):
                            raise RuntimeError('SMTP no disponible para la organización del evento')
                        M.email_service.send_email(
                            subject=f'[Easy Thesis] Actualización: {event.title}',
    ...
    def notify_welcome(user):
        ...
        try:
            notification = M.Notification(
                ...
                title='¡Bienvenido a Easy Thesis!',
                message='Te damos la bienvenida a Easy Thesis. Explora nuestros eventos, recursos y servicios disponibles.'
            )
            M.db.session.add(notification)
