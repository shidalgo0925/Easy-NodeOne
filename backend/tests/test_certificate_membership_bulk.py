...
class TestMembershipCertificateBulk(unittest.TestCase):
    ...
    def test_legacy_snapshot_uses_generated_at(self):
        ...
        user = SimpleNamespace(first_name='Bo', last_name='Li', email='b@x.com', document_id='', cedula=None)
    ...
    def test_ensure_emission_snapshot_persists_legacy(self):
        ...
        user = SimpleNamespace(first_name='X', last_name='Y', email='x@y.com', document_id='', cedula=None)
