...
| **ADR-019 / ADR-020 / ADR-021** | [ADR-019](ADR-019-ADMINISTRATIVE-HIERARCHY.md) · [ADR-020 Order Events](ADR-020-ORDER-EVENT-OWNERSHIP.md) · [ADR-021 Installation Lifecycle](ADR-021-EPOSONE-INSTALLATION-LIFECYCLE.md) · contrato [Installation v1](EN1_EPOSONE_INSTALLATION_LIFECYCLE_CONTRACT_V1.md) (**EN1 C1+C3a+C3b listos**; **Dev flag OFF** hasta que APK envíe `POST /installation/ready`) |
