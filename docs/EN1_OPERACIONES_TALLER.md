...
> **Ubicación canónica:** [backend/docs/EN1_OPERACIONES_TALLER.md](../backend/docs/EN1_OPERACIONES_TALLER.md)  
> (este archivo es un enlace; el workspace de backend abre la copia en `backend/docs/`).

Abrir: `backend/docs/EN1_OPERACIONES_TALLER.md`
...
El resto de multi-tenant (`NODEONE_SINGLE_TENANT_ONLY`, catálogo SaaS, etc.) aplica según [EN1_ARCHITECTURE.md](../backend/docs/EN1_ARCHITECTURE.md).
...
*Documento operativo EN1 — módulo `workshop`. Código fuente: `backend/nodeone/modules/workshop/`.*
