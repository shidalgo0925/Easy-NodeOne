...
| Campo | Valor |
|-------|--------|
| Estado | **Aprobado** — 9 jul 2026 · **supersedido operativamente por V5** (14 jul 2026) |
| Fase actual | Ver **V5** — [`EN1_PLATFORM_EPOSONE_V5_ROADMAP.md`](EN1_PLATFORM_EPOSONE_V5_ROADMAP.md) |
| Handoff | [`EN1_EPOSONE_HANDOFF_STATUS.md`](EN1_EPOSONE_HANDOFF_STATUS.md) |
| **V5 Roadmap** | [`EN1_PLATFORM_EPOSONE_V5_ROADMAP.md`](EN1_PLATFORM_EPOSONE_V5_ROADMAP.md) |
...
| **Hito 3 spec funcional** | [`EN1_EPOSONE_HITO3_SPEC_FUNCIONAL_V1.md`](EN1_EPOSONE_HITO3_SPEC_FUNCIONAL_V1.md) |
...
- **V5 + Order Domain Spec:** registradas 14 jul — H3 **sin código** hasta Spec congelada + GO P1.  
