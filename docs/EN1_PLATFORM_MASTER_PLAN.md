...
**Arquitectura V4 (congelada):** producto independiente con **Modo Local** (SQLite, sin EN1 obligatorio), **Modo Plataforma** (EN1 fuente de verdad + sync § 6.9) y **Vincular con EN1** (Local → Plataforma sin reinstalar). Una sola APK; un solo dominio; SQLite/EN1 = proveedores. **Licenciamiento por Punto de Venta** en EN1 Core ([ADR-005](ADR-005-EPOSONE-LICENSING-POS.md)) — dominio siempre multi-POS; cupos actuales **ilimitados**. Infra POS/LicensePolicy (`18f6593`). **Hito EN1-01 provisioning APIs** (`847a09f`) — E2E tablet pendiente. Handoff: [`EN1_EPOSONE_HANDOFF_STATUS.md`](EN1_EPOSONE_HANDOFF_STATUS.md). Ver [`EN1_PLATFORM_EPOSONE_V4_ROADMAP.md`](EN1_PLATFORM_EPOSONE_V4_ROADMAP.md).
...
| **6** | **Cerrada** — dominio comercial v1.2 aprobado ([`EN1_PLATFORM_ETAPA6_DOMINIO_COMERCIAL.md`](EN1_PLATFORM_ETAPA6_DOMINIO_COMERCIAL.md)) |
...
**Estado:** **cerrada (2026-07-08)** — dominio v1.2 aprobado; contrato de negocio congelado.

**Siguiente:** V3 Etapa 7 — Construcción del dominio (**chat nuevo** + GO explícito de implementación).
...
*Última actualización: 2026-07-08 (V3 Etapa 6 Dominio Comercial cerrada v1.2). Cambios de alcance requieren acuerdo explícito del responsable del proyecto.*
