...
### Gate 1 — EN1 exposición (código, GO futuro)

| Criterio | Owner |
|----------|-------|
| `modality` + `plan_code` comercial en Device `/config` | EN1 |
| Portal instalación mínimo (código, QR, regenerar, devices) | EN1 |
| API Login onboarding (payload § Login Contract) | EN1 |
| Trial 15 / Grace 7 sin tercer período | EN1 |
